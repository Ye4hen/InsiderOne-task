...
import RaceResults from '@/components/home/RaceResults.vue'
...
describe('RaceResults', () => {
  ...
  describe('when race results exist', () => {
    beforeEach(async () => {
      ...
      Object.keys(store.roundProgress).forEach((horseId, index) => {
        store.roundProgress[Number.parseInt(horseId)]!.distance = 101
        store.roundProgress[Number.parseInt(horseId)]!.finishTime = 1000 + index * 100
      })
  ...
  describe('computed properties', () => {
    ...
    it('getMedalIcon should return correct icons', () => {
      ...
      expect(component.getMedalIcon(0)).toBe('🥇')
